...
const editarDB = (actividad) =>{
    ...
    let indexArray = listaEmpleados.findIndex((elemnto) => elemnto.actividad === actividad
    );    
    listaEmpleados[indexArray].editando = true;
    GuardarBd();
...
const PintarDB =() =>{
    ...
    if (listaEmpleados === null){
        ...
        toDoList = JSON.parse(localStorage.getItem('listado_libros'));
        mostrarEmpleados();
    }
    };
...
//pasarle una bandera, para ver si muestra localstorage, 
document.addEventListener('DOMContentLoaded', ()=>{
    //parametros pasar 1, que significa que vaya al local storage y si esta vacio haga la logica de pintar//
    PintarDB()
})
